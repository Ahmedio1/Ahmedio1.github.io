    ...
    <div id="background">
        <section id="presentation">
            <div class="container pt-5">
                ...
                <div class="row pt-5">
                    <h1>Ahmed Daoud</h1>
                    <p class="desc-1">Etudiant en 2e année de DUT informatique</p>
                    <div class="row">
        ...
        <section id="apropos">
            <div class="container">
                    ...
                    <div class="left">
                        <div class="card">
                            <ul>
                                ...
                                <li>
                                    <button type="button" class="btn btn-outline-dark"><a href="pdf/CV.pdf" target="_blank">Mon Cv</a></button>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div><p class="pt-5 para">Je suis étudiant de deuxième année de diplôme Universitaire de Technologie en informatique à l'IUT de Lens,
                ...
                <div class="all-items">
                    <div class="item">
                        ...
                        <div class="right">
                            ...
                            <p class="project-desc pt-3">Pour ce projet en Java, nous devions en équipe de deux
                                utiliser Scanner et compter le nombre de mots dans un fichier, en utilisant différentes méthodes
                                telles que les tableaux, les listes chainées, les arbres binaires et les tables de hashages. </p>
                    ...
                    <div class="item">
                        ...
                        <div class="right">
                            ...
                            <p class="project-desc pt-3">Élaboration d'un jeu de plateau, le labyrinthe en Java, en groupe de 4.</p>
